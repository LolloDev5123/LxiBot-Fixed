...
message.channel.send({embed: {
    ...
    title: "Help",
    description: "This is the Help Menu of LxiBot ",
    fields: [{
        name: "l+ban",
        value: "This command can ban a user "
      },
      {
        name: "All CMDs of a Normal Discord Bot",
        value: "All the commands of a Discord Moderator Bot"
      },
             {
        name: "l+info",
        value: "Shows the informations of the Bot"
      },
      {
        name: "WG Cmds | l+WGJoin - l+WGChat - l+WGInfo",
        value: "All the Commands of WorldGame Community"
      }
    ],
    timestamp: new Date(),
    footer: {
      icon_url: "https://media.discordapp.net/attachments/449572653536247812/450049106992300033/FreeGimo-Logo96.png",
      text: "Lxi Inc. All rights reserved."
    }
  }
});
     }
